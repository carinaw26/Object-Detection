...
if __name__ == '__main__':
  ...
  detector = TFObjectDetector(TF_WORK_DIR + '/Tensorflow/models/research/object_detection/configs/tf2', 
        TF_WORK_DIR + '/Tensorflow/workspace/pre-trained-models/'+ ot_model +'/checkpoint', 
        TF_WORK_DIR + '/Tensorflow/models/research/object_detection/data/mscoco_label_map.pbtxt', 
        ot_model)
